...
func Catalogs() iter.Seq[Reader] {
	return func(yield func(Reader) bool) {
		...
		if !yield(catalog_en_gb{}) {
			return
		}
		if !yield(catalog_sv_se{}) {
			return
		}
	}
}
...
// TIKs
const (
	msg174d508b7de4a66e = `Flour site`
	msg1837c1944267e92c = `When baking gluten-free goods, it's typically best to mix a few different kinds of flours`
